...
### Parameters
TRAIN_PATH <- "c00_lowSNR_input/train/"
TEST_PATH <- "c00_lowSNR_input/test/"
HEIGHT = 256
WIDTH = 256
STACKS = 128
CHANNELS = 1
...
model %>% save_model_hdf5("/scratch/network/ds65/ELE571/stress_outputs/ele571_3d_lowSNR_model_1.h5")
save.image(file = "/scratch/network/ds65/ELE571/stress_outputs/ele571_3d_lowSNR_1.RData")
